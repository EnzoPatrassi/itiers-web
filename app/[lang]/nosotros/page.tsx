  ...
  return (
    <div className="bg-white min-h-screen py-16 px-6 sm:px-12">
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="bg-[#fafafa] p-8 sm:p-12 rounded-[16px] border border-[#b2b2b2] grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-4 bg-[#1f1f1f] text-white p-6 rounded-[12px] space-y-3">
            <div className="text-xs uppercase tracking-wider text-[#ff4f00] font-semibold">
        ...
        <section className="space-y-8" aria-labelledby="methodology-title">
          <div className="text-center max-w-2xl mx-auto">
            <span className="text-xs font-bold text-[#ff4f00] bg-[#fafafa] px-3 py-1 rounded-full uppercase tracking-wider border border-[#b2b2b2]">
              {lang === 'es' ? 'Metodología Spec-Driven (SDD)' : 'Spec-Driven Methodology (SDD)'}
            </span>
            <h2 id="methodology-title" className="text-3xl font-bold text-[#1c1917] mt-3">
              {lang === 'es' ? 'El Humano en el Bucle' : 'The Human in the Loop'}
            </h2>
            <p className="text-stone-700 mt-2 text-sm sm:text-base">
              {lang === 'es'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-[#fafafa] p-6 rounded-[16px] border border-[#b2b2b2] flex flex-col justify-between">
              <div>
                <span className="text-[#ff4f00] font-black text-2xl block mb-2">01</span>
            ...
            <div className="bg-[#fafafa] p-6 rounded-[16px] border border-[#b2b2b2] flex flex-col justify-between">
              <div>
                <span className="text-[#ff4f00] font-black text-2xl block mb-2">02</span>
                <h3 className="text-base font-bold text-[#1c1917] mb-2">
            ...
            <div className="bg-[#fafafa] p-6 rounded-[16px] border border-[#b2b2b2] flex flex-col justify-between">
              <div>
                <span className="text-[#ff4f00] font-black text-2xl block mb-2">03</span>
                <h3 className="text-base font-bold text-[#1c1917] mb-2">
            ...
            <div className="bg-[#fafafa] p-6 rounded-[16px] border border-[#b2b2b2] flex flex-col justify-between">
              <div>
                <span className="text-[#ff4f00] font-black text-2xl block mb-2">04</span>
                <h3 className="text-base font-bold text-[#1c1917] mb-2">
        ...
        <section className="space-y-6 pt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#fafafa] p-6 rounded-[16px] border border-[#b2b2b2]">
              <span className="text-xs font-semibold text-[#ff4f00] uppercase tracking-wider">Argentina</span>
              <h3 className="text-xl font-bold text-[#1c1917] mt-1 mb-2">Mendoza</h3>
              <p className="text-stone-600 text-sm leading-relaxed">Av. Perú 1841, Ciudad de Mendoza, Argentina</p>
            </div>
            <div className="bg-[#fafafa] p-6 rounded-[16px] border border-[#b2b2b2]">
              <span className="text-xs font-semibold text-[#ff4f00] uppercase tracking-wider">Chile</span>
              <h3 className="text-xl font-bold text-[#1c1917] mt-1 mb-2">Santiago</h3>
              <p className="text-stone-600 text-sm leading-relaxed">General del Canto 421, piso 6, Providencia, Santiago de Chile</p>
            </div>
            <div className="bg-[#fafafa] p-6 rounded-[16px] border border-[#b2b2b2]">
              <span className="text-xs font-semibold text-[#ff4f00] uppercase tracking-wider">USA</span>
              <h3 className="text-xl font-bold text-[#1c1917] mt-1 mb-2">Delaware</h3>
              <p className="text-stone-600 text-sm leading-relaxed">651 North Broad Street, Middletown, DE 19709, USA</p>
            </div>
          </div>
        </section>
